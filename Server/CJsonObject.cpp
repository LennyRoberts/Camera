...
bool CJsonObject::Get(const std::string& strKey, int16& iValue) const
{
    cJSON* pJsonStruct = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    {
        iValue = (int16)(pJsonStruct->valueint);
        return(true);
    }
    else if (pJsonStruct->type == cJSON_Double)
    {
        iValue = (int16)(pJsonStruct->valuedouble);
        return(true);
    }
    return(false);
}

bool CJsonObject::Get(const std::string& strKey, uint16& uiValue) const
{
    cJSON* pJsonStruct = NULL;
    if (m_pJsonData != NULL)
    {
    ...
    if (pJsonStruct->type == cJSON_Int)
    {
        uiValue = (uint16)(pJsonStruct->valueint);
        return(true);
    }
    else if (pJsonStruct->type == cJSON_Double)
    {
        uiValue = (uint16)(pJsonStruct->valuedouble);
        return(true);
    }
    return(false);
}
...
bool CJsonObject::Add(const std::string& strKey, int16 iValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
...
bool CJsonObject::Add(const std::string& strKey, uint16 uiValue)
{
    cJSON* pFocusData = NULL;
    if (m_pJsonData != NULL)
    {
